...
namespace SV21T1020081.Shop.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string username, string password)
        {
            ...
            var userAccount = UserAccountService.Authorize(UserType.Customer, username, password);
            if (userAccount == null)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult SignUp(Customer customer, string password, string confirmPassword)
        {
            ...
            var existingCustomer = CommonDataService.ListOfCustomer().FirstOrDefault(c => c.Email == customer.Email);
            ...
            int newCustomerID = CommonDataService.AddCustommer(customer); ;

        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                .AddCookie(option =>
                {
                    ...
                    option.LoginPath = "/Account/Login"; //duong dan trang dang nh?p
                    option.AccessDeniedPath = "/Account/AccessDenined"; // duong dan trang c?m truy cap
